...
{
    public enum EstadosCargasSucursales : byte
    {
        Libre = 0,
        Asignada = 1,
        Terminada = 2,
    ...
    public enum EstadoAprobacionCargas : int
    {
        Aprobada = 1,
        Rechazada = 2,
        Corregida = 3,
    ...
    public class CargaSucursal: MovimientoSucursal
    {
        ...
        protected BindingList<ManifiestoSucursalCarga> _manifiesto;

        public BindingList<ManifiestoSucursalCarga> Manifiesto
        {
        ...
        private Dictionary<Denominacion, List<CartuchoCargaSucursal>> _cartuchos_denominaciones =
            new Dictionary<Denominacion, List<CartuchoCargaSucursal>>();
        ...
        public CargaSucursal(CommonObjects.Sucursal sucursal, byte? emergencia, int id, EmpresaTransporte transportadora, byte? ruta, byte? orden_ruta, float distancia, DateTime hora_programada, int tiempoviaje, bool mutilado)
        {
        ...
        public CargaSucursal(int id, Colaborador cajero, byte ruta, byte orden_ruta, DateTime fecha_verificacion, EstadosCargasSucursales estado, string nombre, string dato)
        {
            // TODO: Complete member initialization
            this.ID = id;
            this.Cajero = cajero;
        ...
        public void agregarCartucho(CartuchoCargaSucursal cartucho)
        {
        ...
        public void quitarCartucho(CartuchoCargaSucursal cartucho)
        {
        ...
        public void recalcularMontosCarga()
        {
            ...
            foreach (CartuchoCargaSucursal cartucho in _cartuchos)
            {
        ...
        public void agregarManifiesto(ManifiestoSucursalCarga m)
        {
            _manifiesto.Add(m);
        }
        ...
        /// </summary>
        /// <param name="m">Objeto ManifiestoSucursalCarga con los datos del manifiesto a remover</param>
        public void quitarManifiesto(ManifiestoSucursalCarga m)
        {
        ...
        private void asignaCartuchoDenominacion(CartuchoCargaSucursal cartucho)
        {
            ...
            {
                List<CartuchoCargaSucursal> cartuchos = new List<CartuchoCargaSucursal>();
