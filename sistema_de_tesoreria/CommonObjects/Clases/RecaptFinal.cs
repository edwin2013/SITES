...
{
    public class RecaptFinal : ObjetoIndexado
    {
       ...
       private DateTime _fecha_ingreso;
        ...
        protected BindingList<MontosRecaptFinal> _cartuchos = new BindingList<MontosRecaptFinal>();

        public BindingList<MontosRecaptFinal> Cartuchos
        {
        ...
        private Dictionary<Denominacion, List<MontosRecaptFinal>> _bolsas_denominaciones =
           new Dictionary<Denominacion, List<MontosRecaptFinal>>();



        protected BindingList<MontosRecaptFinal> _cartuchos_colones = new BindingList<MontosRecaptFinal>();

        public BindingList<MontosRecaptFinal> Cartuchos_Colones
        {
            get { return _cartuchos_colones; }
        }

        protected BindingList<MontosRecaptFinal> _cartuchos_dolares = new BindingList<MontosRecaptFinal>();

        public BindingList<MontosRecaptFinal> Cartuchos_Dolares
        {
            get { return _cartuchos_dolares; }
        }


        protected BindingList<MontosRecaptFinal> _cartuchos_euros = new BindingList<MontosRecaptFinal>();

        public BindingList<MontosRecaptFinal> Cartuchos_Euros
        {
        ...
        public RecaptFinal(int id=0, DateTime? fecha_ingreso = null, EstadoRecapt est = EstadoRecapt.Por_Aprobar, 
        ...
        public RecaptFinal(int id, string serie, DateTime fecha_ingreso, string colaborador)
        {
        ...
        public RecaptFinal(int id, string serie, DateTime fecha_ingreso)
        {
            // TODO: Complete member initialization
            this.id = id;
            this.Fecha_ingreso = fecha_ingreso;
        ...
        public void agregarCartucho(MontosRecaptFinal cartucho)
        {
        ...
        public void quitarCartucho(MontosRecaptFinal cartucho)
        {
        ...
        public void recalcularMontosCarga()
        {
            ...
            foreach (MontosRecaptFinal cartucho in _cartuchos)
            {
        ...
        private void asignaCartuchoDenominacion(MontosRecaptFinal cartucho)
        {
            ...
            {
                List<MontosRecaptFinal> cartuchos = new List<MontosRecaptFinal>();
        ...
        public override bool Equals(object obj)
        {
            ...
            RecaptFinal bolsa = (RecaptFinal)obj;
