...
namespace CommonObjects
{
    ...
    public class CierreATMs : ObjetoIndexado
    {
        ...
        protected BindingList<DescargaATM> _descargas_completa = new BindingList<DescargaATM>();

        public BindingList<DescargaATM> DescargasCompleta
        {
            get { return _descargas_completa; }
            set { _descargas_completa = value; }
        }

        protected BindingList<DescargaATMFull> _descargas_completa_full = new BindingList<DescargaATMFull>();

        public BindingList<DescargaATMFull> DescargasCompleta_full
        {
            get { return _descargas_completa_full; }
            set { _descargas_completa_full = value; }
        }
        ...
        public CierreATMs(Colaborador cajero,
                          int id = 0,
        ...
        {
            _descargas_completa.Add(descarga);
        }
        ...
        /// </summary>
        /// <param name="descarga">Descarga a quitar</param>
        public void quitarDescargaCompleta(DescargaATM descarga)
        {
            _descargas_completa.Remove(descarga);
        }
        ...
        /// </summary>
        /// <param name="descarga">Descarga a agregar</param>
        public void agregarDescargaCompletaFull(DescargaATMFull descarga)
        {
            _descargas_completa_full.Add(descarga);
        }
        ...
        /// </summary>
        /// <param name="descarga">Descarga a quitar</param>
        public void quitarDescargaCompletaFull(DescargaATMFull descarga)
        {
            _descargas_completa_full.Remove(descarga);
        }
