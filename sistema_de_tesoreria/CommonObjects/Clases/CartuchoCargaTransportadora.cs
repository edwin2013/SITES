...
{
    public class CartuchoCargaTransportadora : ObjetoIndexado
    {
        ...
        protected MovimientoTransportadora _movimiento;

        public MovimientoTransportadora Movimiento
        {
        ...
        public CartuchoCargaTransportadora(Denominacion denominacion = null,
                                int id = 0,
                                MovimientoTransportadora movimiento = null,
                                string marchamo = "",
