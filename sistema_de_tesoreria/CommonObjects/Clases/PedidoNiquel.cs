...
{
    public class PedidoNiquel : MovimientoNiquel
    {
        ...
        public string Punto
        {
            get { return _cliente.Cliente.Nombre +"-"+_cliente.Nombre ; }
        ...
        protected BindingList<ManifiestoNiquelPedido> _manifiesto;

        public BindingList<ManifiestoNiquelPedido> Manifiesto
        {
        ...
        private Dictionary<Denominacion, List<CartuchosNiquel>> _cartuchos_denominaciones =
            new Dictionary<Denominacion, List<CartuchosNiquel>>();
        ...
        public PedidoNiquel(CommonObjects.PuntoVenta sucursal, byte? emergencia, int id, EmpresaTransporte transportadora, byte? ruta, byte? orden_ruta, float distancia, DateTime hora_programada, int tiempoviaje, bool mutilado)
        {
            // TODO: Complete member initialization
            this.PuntoVenta = sucursal;
        ...
        public PedidoNiquel(int id, Colaborador cajero, byte ruta, byte orden_ruta, DateTime fecha_verificacion, EstadosCargasSucursales estado, string nombre, string dato)
        {
            // TODO: Complete member initialization
            this.ID = id;
            this.Cajero = cajero;
        ...
        public void agregarCartucho(CartuchosNiquel cartucho)
        {
        ...
        public void quitarCartucho(CartuchosNiquel cartucho)
        {
        ...
        public void recalcularMontosCarga()
        {
            ...
            foreach (CartuchosNiquel cartucho in _cartuchos)
            {
        ...
        public void agregarManifiesto(ManifiestoNiquelPedido m)
        {
            _manifiesto.Add(m);
        }
        ...
        /// </summary>
        /// <param name="m">Objeto ManifiestoNiquelPedido con los datos del manifiesto a remover</param>
        public void quitarManifiesto(ManifiestoNiquelPedido m)
        {
        ...
        private void asignaCartuchoDenominacion(CartuchosNiquel cartucho)
        {
            ...
            {
                List<CartuchosNiquel> cartuchos = new List<CartuchosNiquel>();
