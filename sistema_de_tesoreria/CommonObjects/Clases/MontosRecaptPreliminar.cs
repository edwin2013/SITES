...
{
    public class MontosRecaptPreliminar :ObjetoIndexado
    {
        ...
        protected RecaptPreliminar _recapt;
        public RecaptPreliminar Recapt
        {
            set { _recapt = value; }
            get { return _recapt; }
        }
        ...
        public MontosRecaptPreliminar(Denominacion denominacion = null,
                                int id = 0,
