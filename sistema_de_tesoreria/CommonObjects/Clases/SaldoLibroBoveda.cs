...
{
    public class SaldoLibroBoveda: ObjetoIndexado
    {
        ...
        public SaldoLibroBoveda(int id = 0, DateTime? fecha_asignada = null, Colaborador colaborador = null, Decimal monto_colones = 0, Decimal monto_dolares = 0, Decimal monto_euros = 0, Denominacion d = null, decimal custodia_auxiliar = 0, decimal cola_colones = 0,
