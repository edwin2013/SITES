...
{
    public class CierreCargaTransportadora: ObjetoIndexado
    {
        ...
        protected BindingList<CargaTransportadora> _cargas = new BindingList<CargaTransportadora>();

        public BindingList<CargaTransportadora> Cargas
        {
            get { return _cargas; }
            set { _cargas = value; }
        }
        ...
        public CierreCargaTransportadora(Colaborador cajero,
                          int id = 0,
        ...
        public void agregarCarga(CargaTransportadora carga)
        {
            _cargas.Add(carga);
        }
        ...
        public void quitarCarga(CargaTransportadora carga)
        {
