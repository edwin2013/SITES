...
{
   public class CartuchoCargaSucursal:ObjetoIndexado
    {
        ...
        protected MovimientoSucursal _movimiento;

        public MovimientoSucursal Movimiento
        {
        ...
        public CartuchoCargaSucursal(Denominacion denominacion = null,
                                int id = 0,
