...
{
    public class CartuchosCargaSucursalesDL
    {
         #region Atributos
        ...
        /// </summary>
        private static CartuchosCargaSucursalesDL _instancia;

        /// <summary>
        /// Obtener la instancia única del manejador.
        /// </summary>
        public static CartuchosCargaSucursalesDL Instancia
        {
            get
            {
                if (_instancia == null)
                    _instancia = new CartuchosCargaSucursalesDL();
                return _instancia;
            }
        }
        ...
        public CartuchosCargaSucursalesDL() { }
        ...
        /// </summary>
        /// <param name="c">Objeto CartuchoCargaSucursales con los datos del cartucho</param>
        public void agregarCartuchoCargaSucursales(ref CartuchoCargaSucursal c)
        {
            SqlCommand comando = _manejador.obtenerProcedimiento("InsertCartuchoCargaSucursal");
        ...
        /// </summary>
        /// <param name="c">Objeto CartuchoCargaSucursal con los datos del cartucho</param>
        public void actualizarCartuchoCargaSucursal(ref CartuchoCargaSucursal c)
        {
            SqlCommand comando = _manejador.obtenerProcedimiento("UpdateCartuchoCargaSucursal");
        ...
        /// </summary>
        /// <param name="c">Objeto CartuchoCargaSucursal con los datos del cartucho</param>
        public void actualizarCartuchoCargaSucursalCantidadDescarga(CartuchoCargaSucursal c)
        {
        ...
        {
            SqlCommand comando = _manejador.obtenerProcedimiento("UpdateCartuchoCargaSucursalCantidad");
            ...
            {
                comando.Connection.Close();
                throw new Excepcion("ErrorCartuchoCargaSucursalesActualizacion");
            }
        ...
        /// </summary>
        /// <param name="c">Objeto CartuchoCargaSucursal con los datos del cartucho de la carga del ATM</param>
        public void actualizarCartuchoCargaSucursalCartucho(CartuchoCargaSucursal c)
        {
        ...
        /// </summary>
        /// <param name="c">Objeto CartuchoCargaSucursal con los datos del cartucho</param>
        public void eliminarCartuchoCargaATM(CartuchoCargaSucursal c)
        {
        ...
        public void obtenerCartuchosCargaSucursal(ref CargaSucursal c, bool a)
        {
            SqlCommand comando = _manejador.obtenerProcedimiento("SelectCartuchoCargaSucursal");
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    CartuchoCargaSucursal bolsa_carga = new CartuchoCargaSucursal(denominacion, id: id_cartucho_carga, marchamo: marchamo,
                                                                           movimiento: c,
