...
{
    public partial class frmMantenimientoArqueoBoveda : Form
    {
        #region Atributos
       ...
       public frmMantenimientoArqueoBoveda(Colaborador usuario)
        {
            InitializeComponent();
            _usuario = usuario;        
        }
       ...
       private void btnActualizar_Click(object sender, EventArgs e)
       {
           ...
           {
               BindingList<Arqueo> arqueo = _mantenimiento.listarArqueosBoveda(dtpFecha.Value);
        ...
        {
            if (cboTipoArqueo.Text != "" && cboTipoMoneda.Text != "")
            { 
        ...
        {
           // frmAdministracionArqueoBoveda _padre = (frmAdministracionArqueoBoveda)this.Owner; 
            try
            {
                //if (epError.ToString() == "")
                //{
                    ...
                    nuevo = new Arqueo(id: 0, fecha_ingreso: dtpFecha.Value, colaborador: _usuario, comentario: txtComentario.Text, inicio: dtpInicio.Value, fin: dtpFin.Value,
                        ...
                        codigocajero: txtCodigoCajero.Text, cuentacontable: Convert.ToDecimal(txtCuenta.Text),
                        colas:_colas, mutilado:_mutilado);
                    ...
                    _mantenimiento.importarArqueoBoveda(nuevo, _usuario);
