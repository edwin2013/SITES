...
{
    public partial class frmVerificacionMontosRecapPreliminar : Form
    {
        #region Atributos
        ...
        private RecaptPreliminar _carga = null;
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //_coordinacion.actualizarMontosRecaptPreliminarDatosVerificacion(_carga);
            }
            catch (Excepcion ex)
            {
                ex.mostrarMensaje();
        ...
        private void dgvCartuchos_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            ...
            for (int contador = 0; contador < e.RowCount; contador++)
            {
                ...
                //CartuchoMontosRecaptPreliminar cartucho = (CartuchoMontosRecaptPreliminar)fila.DataBoundItem;
