...
{
    public partial class frmAgregarCartuchoCargaSucursal : Form
    {
        ...
        /// </summary>
        private void asignarCartuchos(double p_monto, ref CargaSucursal carga,Denominacion denominacion)
        {
        ...
        private void frmAgregarCartuchoCargaSucursal_Load(object sender, EventArgs e)
        {
