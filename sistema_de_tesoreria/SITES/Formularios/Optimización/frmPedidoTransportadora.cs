...
{
    public partial class frmPedidoTransportadora : Form
    {
         #region Atributos
        ...
        private BindingList<CargaTransportadora>  _cargas = new BindingList<CargaTransportadora>();
        ...
        public frmPedidoTransportadora(Colaborador colaborador)
        {
            InitializeComponent();
            _total_colones = 0;
            _total_dolares = 0;
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ValidarCampos() && ValidaErroneos())
                {
                        ...
                        CargaTransportadora nueva = _cargas[0];
                        nueva.ColaboradorVerificadorTransportadora = _colaborador_verificacion;
                        _coordinacion.importarCargasTransportadora(ref nueva,_colaborador);
...
//////////////////////////////////////// HABILITA /////////////////////////////////////////
                                         ...
                                         Dictionary<double,decimal> denominaciones,ArrayList numeros)
        {
           ...
           // this.identificarDenominaciones(numeros, moneda);
                ...
                EmpresaTransporte sucursal = (EmpresaTransporte)cboTransportadora.SelectedItem;

                CargaTransportadora carga = this.buscarCarga(sucursal, fecha);
        ...
        /// </summary>
        private CargaTransportadora buscarCarga(EmpresaTransporte sucursal, DateTime fecha)
        {
            CargaTransportadora nueva = new CargaTransportadora();
            EmpresaTransporte emp = (EmpresaTransporte)cboTransportadora.SelectedItem;
            nueva.Colaborador_Registro = _colaborador;
            foreach (CargaTransportadora carga in _cargas)
                if (carga.Transportadora.ID == sucursal.ID)
                    return carga;
            

                nueva = new CargaTransportadora(transportadora: emp, fecha_asignada: dtpFecha.Value, cajero: _colaborador, manifiesto: null, estado: EstadosCargasSucursales.Entrega_Boveda);
        ...
        /// </summary>
        private void asignarCartuchos(double p_monto, ref CargaTransportadora carga,Dictionary<double,decimal> denominaciones,Monedas moneda)
        {
            decimal monto = 0;
