...
{
    public partial class frmModificacionCargaTransportadora : Form
    {
        #region Atributos

        private CoordinacionBL _coordinacion = CoordinacionBL.Instancia;
        private CargaTransportadora _carga = null;
        ...
        /// </summary>
        /// <param name="carga">Objeto CargaTransportadora con los datos de la sucursal</param>
        ...
        public frmModificacionCargaTransportadora(CargaTransportadora carga, Colaborador colaborador, bool solo_lectura)
        {
            InitializeComponent();
            _carga = carga;
            _colaborador = colaborador;
            lblNombre.Text = carga.Transportadora.Nombre;
        ...
        {
            frmAgregarCartuchoCargaTransportadora formulario = new frmAgregarCartuchoCargaTransportadora(_colaborador,_carga);
        ...
        private void actualizarCartucho(DataGridViewRow fila)
        {
            ...
            try
            {
                CartuchoCargaTransportadora cartucho = (CartuchoCargaTransportadora)fila.DataBoundItem;
                ...
                if (cartucho.Cantidad_carga % 100 == 0)
                {
                    ...
                    formulario.Padre10 = this;
                    formulario.ShowDialog();

                    cartucho.Comentario = _comentario;

                    dgvMontosCarga.Rows[fila.Index].Cells[4].ErrorText = "";
                    _coordinacion.actualizarCartuchoCargaTransportadoraCantidad(cartucho);
                }
                else
                {
