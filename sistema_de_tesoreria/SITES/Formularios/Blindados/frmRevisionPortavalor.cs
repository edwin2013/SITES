...
{
    public partial class frmRevisionPortavalor : Form
    {
        #region Atributos
        ...
        public frmRevisionPortavalor(Colaborador colaborador)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                cboPortavalor.ListaMostrada = _seguridad.listarColaboradoresPorPuestoArea(Areas.Blindados, Puestos.Chofer);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Colaborador chofer = cboPortavalor.SelectedIndex == 0 ?
                    null : (Colaborador)cboPortavalor.SelectedItem;
                
                int ruta = chkRuta.Checked ?
                    (int)nudRuta.Value : 0;

                dgvCargas.DataSource = _coordinacion.obtenerReporteRevisionPortavalor(fecha, fechafin, chofer, ruta);
            }
            catch (Excepcion ex)
            {
                ex.mostrarMensaje();
