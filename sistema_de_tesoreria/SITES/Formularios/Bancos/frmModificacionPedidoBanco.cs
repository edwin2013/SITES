...
{
    public partial class frmModificacionPedidoBancos : Form
    {
        #region Atributos
        ...
        /// </summary>
        /// <param name="carga">Objeto PedidoBancos con los datos de la sucursal</param>
        ...
        public frmModificacionPedidoBancos(PedidoBancos carga, Colaborador colaborador, bool solo_lectura)
        {
            InitializeComponent();
            _carga = carga;
        ...
        {
            frmAgregarCartuchoPedidoBancos formulario = new frmAgregarCartuchoPedidoBancos(_colaborador,_carga);
