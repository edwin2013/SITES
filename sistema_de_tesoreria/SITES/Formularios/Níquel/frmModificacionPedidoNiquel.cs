...
{
    public partial class frmModificacionPedidoNiquel : Form
    {
        #region Atributos
        ...
        /// </summary>
        /// <param name="carga">Objeto PedidoNiquel con los datos de la sucursal</param>
        ...
        public frmModificacionPedidoNiquel(PedidoNiquel carga, Colaborador colaborador, bool solo_lectura)
        {
            InitializeComponent();
            _carga = carga;
        ...
        {
            frmAgregarCartuchoNiquel formulario = new frmAgregarCartuchoNiquel(_colaborador, _carga);
        ...
        private void actualizarCartucho(DataGridViewRow fila)
        {
            ...
            try
            {
                CartuchosNiquel cartucho = (CartuchosNiquel)fila.DataBoundItem;
