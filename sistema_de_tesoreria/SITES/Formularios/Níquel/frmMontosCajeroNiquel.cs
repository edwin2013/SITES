...
{
    public partial class frmMontosCajeroNiquel : Form
    {
        #region Atributos
        ...
        public frmMontosCajeroNiquel(BindingList<PedidoNiquel> cargas)
        {
            InitializeComponent();
            ...
            foreach (PedidoNiquel carga in cargas)
            {
                ...
                foreach (CartuchosNiquel cartucho in carga.Cartuchos)
                {
