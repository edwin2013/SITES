...
{
    public partial class frmAgregarCartuchoNiquel : Form
    {
        #region Atributos
        ...
        /// </summary>
        private void asignarCartuchos(double p_monto, ref PedidoNiquel carga,Denominacion denominacion)
        {
