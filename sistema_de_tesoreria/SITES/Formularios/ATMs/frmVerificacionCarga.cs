//
//  @ Project : 
//  @ File Name : frmVerificacionCarga.cs
//  @ Date : 19/09/2012
...
namespace GUILayer
{
    ...
    public partial class frmVerificacionCarga : Form
    {
        ...
        public frmVerificacionCarga(CargaATM carga)
        {
            InitializeComponent();
           ...
           // dgvCartuchos.Sort(dgvCartuchos.Columns[0], ListSortDirection.Descending);
            chkCartuchoRechazo.Enabled = _carga.Cartucho_rechazo;
        }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _coordinacion.actualizarCargaATMDatosVerificacion(_carga);
            }
            catch (Excepcion ex)
            {
                ex.mostrarMensaje();
        ...
        /// <summary>
        /// Se marca o desmarca la opción de cartucho de rechazo.
        /// </summary>
        private void chkCartuchoRechazo_CheckedChanged(object sender, EventArgs e)
        {
            this.verificarRevision();
        }
        ...
        private void verificarRevision()
        {
            ...
            else
            {
                ...
                foreach (DataGridViewRow fila in dgvCartuchos.Rows)
                {
                    ...
                    bool estado = (bool)celda_revisado.Value;
                ...
                if (_carga.Cartucho_rechazo && !chkCartuchoRechazo.Checked) revisado = false;
