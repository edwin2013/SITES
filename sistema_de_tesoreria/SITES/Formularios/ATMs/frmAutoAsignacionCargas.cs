...
namespace GUILayer
{
    public partial class frmAutoAsignacionCargas : Form
    {
        ...
        Dictionary<Colaborador, List<CargaATM>> _cargas_asignadas = null;

        #endregion Atributos

        #region Constructor

        public frmAutoAsignacionCargas()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                BindingList<Colaborador> cajeros = _seguridad.listarColaboradoresPorPuestoArea(Areas.ATMs, Puestos.CajeroA, Puestos.CajeroB);
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                frmAsignacionCargas padre = (frmAsignacionCargas)this.Owner;
