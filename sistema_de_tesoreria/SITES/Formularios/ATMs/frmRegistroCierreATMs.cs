...
namespace GUILayer
{
    ...
    public partial class frmRegistroCierreATMs : Form
    {
        ...
        public frmRegistroCierreATMs(Colaborador usuario)
        {
            InitializeComponent();

            tpDevolucionDispensador.Parent = null;
            tpDescargasCompletasDispensador.Parent = null;
            tpDescargasCompletasFull.Parent = null;
            ...
            try
            {
                ...
                //Descargas Completas
                dgvDescargasCompletas.AutoGenerateColumns = false;
                dgvMontosDescargaCompleta.AutoGenerateColumns = false;
                dgvContadoresDescargasCompletas.AutoGenerateColumns = false;
                dgvDiferenciasRemanentesDescarga.AutoGenerateColumns = false;
                dgvDiferenciasContadoresDescargasCompletas.AutoGenerateColumns = false;
                ...
                ((Control)tpDescargasCompletasDispensador).Enabled = false;
                ((Control)tpDescargasCompletasFull).Enabled = false;
                ((Control)tpDevolucionDispensador).Enabled = false;
        ...
        private void dgvMontosCarga_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dgvMontosCarga.SelectedCells.Count > 0)
            {
                ...
                btnManifiestoGeneral.Enabled = true;
                switch (carga.Tipo)
                {
            ...
            else
            {
                ...
                btnManifiestoGeneral.Enabled = false;
            }
        ...
        #region Descargas Completas

        /// <summary>
        /// Clic en el botón de seleccionar las descargas pendientes.
        /// </summary>
        private void btnDescargasCompletasPendientes_Click(object sender, EventArgs e)
        {

            try
            {
                frmDescargasCompletasPendiente formulario = new frmDescargasCompletasPendiente(_cierre);
        ...
        /// Clic en el botón de devolver una descarga.
        /// </summary>
        private void btnDevolverDescargaCompleta_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Mensaje.mostrarMensajeConfirmacion("MensajeDescargaATMDevolucion") == DialogResult.Yes)
                {
                    DescargaATM descarga = (DescargaATM)dgvDescargasCompletas.SelectedRows[0].DataBoundItem;

                    _coordinacion.eliminarDescargaATM(descarga);

                    dgvDescargasCompletas.Rows.Remove(dgvDescargasCompletas.SelectedRows[0]);
                    Mensaje.mostrarMensaje("MensajeDescargaATMConfirmacionDevolucion");
                }
        ...
        /// Se presiona el botón de finalizar descarga.
        /// </summary>
        private void btnMarcarFinDescargaCompleta_Click(object sender, EventArgs e)
        {
            dtpHoraFinDescargaCompleta.Value = DateTime.Now;
        }
        ...
        /// Clic en el botón de seleccionar el manifiesto de una descarga.
        /// </summary>
        private void btnSeleccionarManifiestoDescargaCompleta_Click(object sender, EventArgs e)
        {
            DescargaATM descarga = (DescargaATM)dgvDescargasCompletas.SelectedRows[0].DataBoundItem;
        ...
        /// Se selecciona otra descarga en la lista de descargas.
        /// </summary
        private void dgvDescargasCompletas_SelectionChanged(object sender, EventArgs e)
        {


            if (dgvDescargasCompletas.SelectedRows.Count > 0)
            {
                _descarga_completa = (DescargaATM)dgvDescargasCompletas.SelectedRows[0].DataBoundItem;
                this.mostrarDatosDescargaCompletaATM();
            }
            else
            {
                _descarga_completa = null;
                this.limpiarDatosDescargaCompleta();
            }
        ...
        /// Se cambia la cantidad de fórmulas descargadas de un cartucho de una descarga.
        /// </summary
        private void dgvMontosDescargaCompleta_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {

            if (dgvMontosDescargaCompleta.RowCount > 0)
            {

                try
                {
                    DataGridViewRow fila = dgvMontosDescargaCompleta.Rows[e.RowIndex];
                    TiposFila tipo = (TiposFila)fila.Cells[TipoFilaDescargaCompleta.Index].Value;
                    short cantidad = (short)fila.Cells[CantidadCartuchoDescargaCompleta.Index].Value;

                    switch (tipo)
                    {
                        case TiposFila.Cartucho:
                            CartuchoCargaATM cartucho = (CartuchoCargaATM)fila.Cells[ObjetoDescargaCompleta.Index].Value;

                            cartucho.Cantidad_descarga = cantidad;

                            _coordinacion.actualizarCartuchoCargaATMCantidadDescarga(cartucho);

                            fila.Cells[MontoDescargaCompleta.Index].Value = cartucho.Monto_descarga;

                            break;
                        case TiposFila.Rechazo:
                            RechazoDescargaATM rechazo = (RechazoDescargaATM)fila.Cells[ObjetoDescargaCompleta.Index].Value;

                            rechazo.Cantidad_descarga = cantidad;

                            _coordinacion.actualizarRechazoDescargaATM(rechazo);

                            fila.Cells[MontoDescargaCompleta.Index].Value = rechazo.Monto_descarga;
        ...
        /// Se valida la cantidad descargada de un cartucho.
        /// </summary
        private void dgvMontosDescargaCompleta_CellParsing(object sender, DataGridViewCellParsingEventArgs e)
        {
            short cantidad = 0;
        ...
        /// Validar la asignación de la cantidad de fórmulas descargadas de un cartucho.
        /// </summary
        private void dgvMontosDescargaCompleta_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {

            if (e.ColumnIndex != CantidadCartuchoDescargaCompleta.Index || e.FormattedValue.Equals(string.Empty))
                return;
        ...
        /// Se cambia la cantidad del contador de una descarga.
        /// </summary
        private void dgvContadoresDescargaCompleta_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {

            if (dgvContadoresDescargasCompletas.RowCount > 0)
            {

                try
                {
                    DataGridViewRow fila = dgvContadoresDescargasCompletas.Rows[e.RowIndex];
                    ContadorDescargaATM contador = (ContadorDescargaATM)fila.DataBoundItem;
        ...
        /// Se valida las cantidades de los contadores de una descarga.
        /// </summary
        private void dgvContadoresDescargaCompleta_CellParsing(object sender, DataGridViewCellParsingEventArgs e)
        {
            short cantidad = 0;
        ...
        /// La lista de cartuchos de una descarga obtiene el foco.
        /// </summary>
        private void dgvMontosDescargaCompleta_Enter(object sender, EventArgs e)
        {

            if (dgvMontosDescargaCompleta.RowCount > 0)
                dgvMontosDescargaCompleta[MontoDescargaCompleta.Index, 0].Selected = true;
        ...
        /// Se selecciona otra fecha para una descarga.
        /// </summary
        private void dtpFechaDescargaCompleta_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaCompleta();
        }

        /// <summary>
        /// Se selecciona otra hora de inicio para una descarga.
        /// </summary
        private void dtpHoraInicioDescargaCompleta_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaCompleta();
        }
        ...
        /// Se selecciona otra hora de finalización para una descarga.
        /// </summary
        private void dtpHoraFinDescargaCompleta_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaCompleta();
        }
        ...
        /// Se selecciona otra hora para una diferencia.
        /// </summary
        private void dtpHoraDiferenciaDescargaCompleta_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaCompleta();
        }
        ...
        /// El cuadro de texto del comentario de una descarga pierde el foco.
        /// </summary
        private void txtObservacionesDescargaCompleta_Leave(object sender, EventArgs e)
        {
            this.guardarDescargaCompleta();
        }
        ...
        /// Clic en el botón de devolver una descarga full.
        /// </summary>
        private void btnDevolverDescargaFullCompleta_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Mensaje.mostrarMensajeConfirmacion("MensajeDescargaATMFullDevolucion") == DialogResult.Yes)
                {
                    DescargaATMFull descarga = (DescargaATMFull)dgvDescargasFullCompleta.SelectedRows[0].DataBoundItem;

                //    _coordinacion.eliminarDescargaATMFullCompleta(descarga);

                    dgvDescargasFullCompleta.Rows.Remove(dgvDescargasFullCompleta.SelectedRows[0]);
                    Mensaje.mostrarMensaje("MensajeDescargaATMFullConfirmacionDevolucion");
                }
        ...
        /// Se presiona el botón de finalizar descarga full.
        /// </summary>
        private void btnMarcarFinDescargaFullCompleta_Click(object sender, EventArgs e)
        {
            dtpHoraFinDescargaFullCompleta.Value = DateTime.Now;
        }
        ...
        /// Clic en el botón de seleccionar el manifiesto de una descarga full.
        /// </summary>
        private void btnSeleccionarManifiestoDescargaFullCompleta_Click(object sender, EventArgs e)
        {
            DescargaATMFull descarga = (DescargaATMFull)dgvDescargasFullCompleta.SelectedRows[0].DataBoundItem;
            frmSeleccionManifiestoDescargaATMFull formulario = new frmSeleccionManifiestoDescargaATMFull(descarga);
        ...
        /// Se selecciona otra descarga en la lista de descargas full.
        /// </summary
        private void dgvDescargasFullCompleta_SelectionChanged(object sender, EventArgs e)
        {

            if (dgvDescargasFullCompleta.SelectedRows.Count > 0)
            {
                _descarga_full_completa = (DescargaATMFull)dgvDescargasFullCompleta.SelectedRows[0].DataBoundItem;
             //   this.mostrarDatosDescargaCompletaATMFull();
            }
            else
            {
                _descarga_full_completa = null;
                this.limpiarDatosDescargaCompletaFull();
            }
        ...
        /// Se cambia la cantidad de fórmulas descargadas de un BNA full.
        /// </summary
        private void dgvMontosDescargaFullCompleta_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {

            if (dgvMontosDescargaCompletaFull.RowCount > 0)
            {

                try
                {
                    DataGridViewRow fila = dgvMontosDescargaCompletaFull.Rows[e.RowIndex];
                    TiposFila tipo = (TiposFila)fila.Cells[TipoFilaDescargaCompletaFull.Index].Value;
                    short cantidad = (short)fila.Cells[CantidadCartuchoDescargaCompletaFull.Index].Value;
                    MontoDescargaATMFull monto = (MontoDescargaATMFull)fila.Cells[ObjetoDescargaCompletaFull.Index].Value;

                    monto.Cantidad = cantidad;

               //     _coordinacion.actualizarMontoDescargaCompletaATMFull(monto);

                    fila.Cells[MontoCartuchoDescargaCompletaFull.Index].Value = monto.Monto_descarga;

               //     this.actualizarTotalesMontosDescargaFullCompleta();
                }
                catch (Excepcion ex)
                {
                    ex.mostrarMensaje();
        ...
        /// Se valida la cantidad descargada de un BNA.
        /// </summary
        private void dgvMontosDescargaCompletaFull_CellParsing(object sender, DataGridViewCellParsingEventArgs e)
        {
            short cantidad = 0;
        ...
        /// Validar la asignación de la cantidad de fórmulas descargadas de un BNA.
        /// </summary
        private void dgvMontosDescargaCompletaFull_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
        ...
        /// Se cambia la cantidad del contador de una descarga full.
        /// </summary
        private void dgvContadoresDescargaCompletaFull_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {

            if (dgvContadoresDescargaFullCompleta.RowCount > 0)
            {
        ...
        /// Se valida las cantidades de los contadores de una descarga full.
        /// </summary
        private void dgvContadoresDescargaCompletaFull_CellParsing(object sender, DataGridViewCellParsingEventArgs e)
        {
            short cantidad = 0;
        ...
        /// La lista de montos de una descarga full obtiene el foco.
        /// </summary>
        private void dgvMontosDescargaCompletaFull_Enter(object sender, EventArgs e)
        {

            if (dgvMontosDescargaCompletaFull.RowCount > 0)
                dgvMontosDescargaCompletaFull[MontoCartuchoDescargaCompletaFull.Index, 0].Selected = true;
        ...
        /// Clic en el botón de seleccionar las descargas full pendientes.
        /// </summary>
        private void btnDescargasCompletasFullPendientes_Click(object sender, EventArgs e)
        {

            try
            {
                //frmDescargasCompletasFullPendientes formulario = new frmDescargasCompletasFullPendientes(_cierre);
        ...
        /// Se selecciona otra fecha para una descarga full.
        /// </summary
        private void dtpFechaDescargaCompletaFull_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaFullCompleta();
        }

        /// <summary>
        /// Se selecciona otra hora de inicio para una descarga full.
        /// </summary
        private void dtpHoraInicioDescargaCompletaFull_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaFullCompleta();
        }
        ...
        /// Se selecciona otra hora de finalización para una descarga full.
        /// </summary
        private void dtpHoraFinDescargaCompletaFull_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaFullCompleta();
        }
        ...
        /// Se selecciona otra hora para una diferencia de una descarga full.
        /// </summary
        private void dtpHoraDiferenciaDescargaCompletaFull_ValueChanged(object sender, EventArgs e)
        {
            this.guardarDescargaFullCompleta();
        }
        ...
        /// El cuadro de texto del comentario de una descarga full pierde el foco.
        /// </summary
        private void txtObservacionesDescargaCompletaFull_Leave(object sender, EventArgs e)
        {
            this.guardarDescargaFullCompleta();
        }
        ...
        private void tbTamanoFuente_Scroll(object sender, EventArgs e)
        {
            ...
            dgvContadoresDescargasCompletas.DefaultCellStyle.Font = fuente;
            dgvDiferenciasContadoresDescargasCompletas.DefaultCellStyle.Font = fuente;
            dgvDiferenciasRemanentesDescargasComplestas.DefaultCellStyle.Font = fuente;
            ...
            dgvContadoresDescargaFullCompleta.DefaultCellStyle.Font = fuente;
            dgvDiferenciasDescargaFullCompleta.DefaultCellStyle.Font = fuente;
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dgvCargaDevolucion.DataSource = descargas;
            }
            catch (Excepcion ex)
            {
                ex.mostrarMensaje();
        ...
        /// <summary>
        /// Cambio en la sección de devolución de descargas
        /// </summary>
        private void dgvCargaDevolucion_SelectionChanged(object sender, EventArgs e)
        {
            if (dgvCargaDevolucion.SelectedRows.Count > 0)
            {
                DescargaATM descarga = (DescargaATM)dgvCargaDevolucion.SelectedRows[0].DataBoundItem;
        ...
        /// <summary>
        /// Devuelve y finaliza una carga respectiva 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnDevolver_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _coordinacion.actualizarCargaDevolucion(descarga);
        ...
        private void imprimirDescarga()
        {
            ...
            try
            {
                ...
                documento.seleccionarCelda("A51");
                documento.actualizarValorCelda(_cierre.Cajero.ToString() + " " + fecha);

                documento.seleccionarCelda("E51");
        ...
        private void escribirHojaDescarga(DocumentoExcel documento, DescargaATM descarga, int numero_hoja)
        {
            ...
            this.escribirCartuchosDescargaImpresion(documento, descarga.Cartuchos_Dolares, 39);
            
            // Imprimir los montos de los rechazos

            this.escribirRechazosDescargaImpresion(documento, descarga.Rechazos_Colones, 23);
            this.escribirRechazosDescargaImpresion(documento, descarga.Rechazos_Dolares, 40);

            // Imprimir los montos de los contadores

            this.escribirContadoresDescargaImpresion(documento, descarga.Contadores_Colones, 61);
            this.escribirContadoresDescargaImpresion(documento, descarga.Contadores_Dolares, 72);

            // Imprimir los montos de carga

            this.escribirMontosCargaDescargaImpresion(documento, descarga.Cartuchos_Colones, 102);
            this.escribirMontosCargaDescargaImpresion(documento, descarga.Cartuchos_Dolares, 117);

            // Imprimir las denominaciones de las diferencias

            this.escribirDiferenciasDescargaImpresion(documento, descarga.Detalles_Colones, 83);
            this.escribirDiferenciasDescargaImpresion(documento, descarga.Detalles_Dolares, 95);
            this.escribirDiferenciasDescargaImpresion(documento, descarga.Detalles_Colones, 127);
            this.escribirDiferenciasDescargaImpresion(documento, descarga.Detalles_Dolares, 139);
        }
        ...
        private void mostrarDatosCierre()
        {
            ...
            dgvDescargasCompletas.DataSource = _cierre.DescargasCompleta;
            dgvDescargasFullCompleta.DataSource = _cierre.DescargasCompleta_full;
        ...
        /// Mostrar los datos de la descarga de ATM.
        /// </summary
        private void mostrarDatosDescargaCompletaATM()
        {
            _descarga_completa_mostrada = false;

            if (_descarga_completa.Hora_inicio.DayOfWeek == DayOfWeek.Sunday)
            {
                dtpFechaDescargaCompleta.Value = _descarga_completa.Hora_inicio.AddDays(-1);
            }
            else
            {
                dtpFechaDescargaCompleta.Value = _descarga_completa.Hora_inicio;
            }
            dtpHoraInicioDescargaCompleta.Value = _descarga_completa.Hora_inicio;
            dtpHoraFinDescargaCompleta.Value = _descarga_completa.Hora_finalizacion;
            dtpHoraDiferenciaDescargaCompleta.Value = _descarga_completa.Hora_diferencia;
            txtObservacionesDescargaCompleta.Text = _descarga_completa.Observaciones;

            // Mostrar el manifiesto

            if (_descarga_completa.Manifiesto == null)
            {
                txtManifiestoDescargaCompleta.Text = string.Empty;
                txtMarchamoDescargaCompleta.Text = string.Empty;
            }
            else
            {
                txtManifiestoDescargaCompleta.Text = _descarga_completa.Codigo_manifiesto;
                txtMarchamoDescargaCompleta.Text = _descarga_completa.Codigo_marchamo;
            }

            // Mostrar los datos de los contadores y el detalle de los montos por denominación

            dgvContadoresDescargasCompletas.DataSource = _descarga_completa.Contadores;
            dgvDiferenciasRemanentesDescargasComplestas.DataSource = _descarga_completa.Detalles;
            dgvDiferenciasContadoresDescargasCompletas.DataSource = _descarga_completa.Detalles;

            // Mostrar los datos de los cartuchos y los rechazos

            dgvMontosDescargaCompleta.Rows.Clear();

            // Colones

            foreach (CartuchoCargaATM cartucho in _descarga.Cartuchos_Colones)
                this.agregarFilaCartuchoDescargaCompletaATM(cartucho);

            foreach (RechazoDescargaATM rechazo in _descarga.Rechazos_Colones)
                this.agregarFilaRechazoDescargaCompletaATM(rechazo);

            dgvMontosDescargaCompleta.Rows.Add("T. Descarga", _descarga_completa.Monto_descarga_colones, null, null, null, TiposFila.TotalDescargaColones);
            dgvMontosDescargaCompleta.Rows.Add("T. Dispensado", _descarga_completa.Monto_dispensado_colones, null, null, null, TiposFila.TotalDispensadoColones);
            dgvMontosDescargaCompleta.Rows.Add("T. Llenado", _descarga_completa.Monto_carga_colones, null, null, null, TiposFila.TotalCargaColones);
            dgvMontosDescargaCompleta.Rows.Add("Diferencia", _descarga_completa.Diferencia_colones, null, null, null, TiposFila.TotalDiferenciaColones);
            ...
            dgvMontosDescargaCompleta.Rows.Add("T. Descarga", _descarga_completa.Monto_descarga_dolares, null, null, null, TiposFila.TotalDescargaDolares);
            dgvMontosDescargaCompleta.Rows.Add("T. Dispensado", _descarga_completa.Monto_dispensado_dolares, null, null, null, TiposFila.TotalDispensadoDolares);
            dgvMontosDescargaCompleta.Rows.Add("T. Llenado", _descarga_completa.Monto_carga_dolares, null, null, null, TiposFila.TotalCargaDolares);
            dgvMontosDescargaCompleta.Rows.Add("Diferencia", _descarga_completa.Diferencia_dolares, null, null, null, TiposFila.TotalDiferenciaDolares);

            // Dar formato a las celdas totales

            foreach (DataGridViewRow fila in dgvMontosDescargaCompleta.Rows)
            {
                TiposFila tipo = (TiposFila)fila.Cells[TipoFilaDescargaCompleta.Index].Value;
            ...
            pbDiferenciaDescargaCompleta.BackColor = _descarga_completa.Cuadrada ? Color.Green : Color.Red;

            _descarga_mostrada = true;
        }

        /// <summary>
        /// Agregar una fila de un cartucho a los montos de una descarga completa
        /// </summary
        private void agregarFilaCartuchoDescargaCompletaATM(CartuchoCargaATM cartucho)
        {
            dgvMontosDescargaCompleta.Rows.Add(cartucho.Denominacion, cartucho.Monto_descarga, cartucho.Cantidad_descarga,
                                       cartucho.Cartucho, cartucho.Marchamo, TiposFila.Cartucho, cartucho);
        }
        ...
        /// Agregar la fila de un rechazo a los montos de una descarga.
        /// </summary
        private void agregarFilaRechazoDescargaCompletaATM(RechazoDescargaATM rechazo)
        {
            dgvMontosDescargaCompleta.Rows.Add(rechazo, rechazo.Monto_descarga, rechazo.Cantidad_descarga,
                                       null, null, TiposFila.Rechazo, rechazo);
        }
        ...
        private void validarDatosCierre()
        {
            ...
            else
            {
                ...
                ((Control)tpDescargasCompletasDispensador).Enabled = true;
                ((Control)tpDescargasCompletasFull).Enabled = true;
                ((Control)tpDevolucionDispensador).Enabled = true;
        ...
        /// Validar si se pueden modificar o no los datos de una descarga.
        /// </summary
        private void validarOpcionesDescargaCompleta()
        {

            if (_descarga_completa == null)
            {
                pnlDatosDescargaCompleta.Enabled = false;
                pnlOpcionesDescargaCompleta.Enabled = false;
                this.habilitarModificacionCartuchosDescargaCompleta(false);
            }
            else if (_coordinador || _cierre.Activo)
            {
                pnlDatosDescargaCompleta.Enabled = true;
                pnlOpcionesDescargaCompleta.Enabled = true;
                this.habilitarModificacionCartuchosDescargaCompleta(true);
            }
            else
            {
                pnlDatosDescargaCompleta.Enabled = false;
        ...
        /// Validar si se pueden modificar o no los datos de una descarga full.
        /// </summary
        private void validarOpcionesDescargaCompletaFull()
        {

            //if (_descarga_full == null)
            //{
            //    pnlDatosDescargaCompletaFull.Enabled = false;
            //    pnlOpcionesDescargasCompletaFull.Enabled = false;
            //    this.habilitarModificacionMontoDescargaCompletaFull(false);
            //}
            //else if (_coordinador || _cierre.Activo)
            //{
            //    pnlDatosDescargaCompletaFull.Enabled = true;
            //    pnlOpcionesDescargasCompletaFull.Enabled = true;
            //    this.habilitarModificacionMontoDescargaCompletaFull(true);
            //}
            //else
            //{
            //    pnlDatosDescargaCompletaFull.Enabled = false;
        ...
        /// Habilitar o deshabilitar la opción de modificar los datos de un cartucho de descarga.
        /// </summary>
        private void habilitarModificacionCartuchosDescargaCompleta(bool estado)
        {
            CantidadCartuchoDescargaCompleta.ReadOnly = !estado;
        }

        /// <summary>
        /// Habilitar o deshabilitar la opción de modificar los datos de un monto de descarga full.
        /// </summary>
        private void habilitarModificacionMontoDescargaCompletaFull(bool estado)
        {
           // CantidadDescargaFullCompleta.ReadOnly = !estado;
        }
        ...
        /// Limpiar los datos de la descarga seleccionada.
        /// </summary>
        private void limpiarDatosDescargaCompleta()
        {
            _descarga_mostrada = false;

            dtpHoraInicioDescargaCompleta.Value = DateTime.Now;
            dtpHoraFinDescargaCompleta.Value = DateTime.Now;

            txtObservacionesDescargaCompleta.Text = string.Empty;
            txtManifiestoDescargaCompleta.Text = string.Empty;
            txtMarchamoDescargaCompleta.Text = string.Empty;

            dgvMontosDescargaCompleta.DataSource = null;
            dgvContadoresDescargasCompletas.DataSource = null;
            dgvDiferenciasContadoresDescargasCompletas.DataSource = null;
            dgvDiferenciasRemanentesDescargasComplestas.DataSource = null;
        ...
        /// Limpiar los datos de la descarga full seleccionada.
        /// </summary>
        private void limpiarDatosDescargaCompletaFull()
        {
            _descarga_full_mostrada = false;

            dtpHoraInicioDescargaFullCompleta.Value = DateTime.Now;
            dtpHoraFinDescargaFullCompleta.Value = DateTime.Now;

            txtObservacionesDescargaFullCompleta.Text = string.Empty;
            txtManifiestoDescargaFullCompleta.Text = string.Empty;
            txtMarchamoDescargaFullCompleta.Text = string.Empty;

            dgvMontosDescargaCompletaFull.DataSource = null;
            dgvContadoresDescargaFullCompleta.DataSource = null;
            dgvDiferenciasDescargaFullCompleta.DataSource = null;
        ...
        private void limpiarDatosCierre()
        {
            ...
            dgvDescargasCompletas.DataSource = null;
            dgvDescargasFullCompleta.DataSource = null; 
        ...
        /// Guardar los datos de una descarga.
        /// </summary>
        private void guardarDescargaCompleta()
        {
            ...
            if (_descarga_mostrada)
            {
                ...
                try
                {
                    _descarga_completa.Fecha = dtpFechaDescargaCompleta.Value;
                    _descarga_completa.Hora_inicio = dtpHoraInicioDescarga.Value;
                    _descarga_completa.Hora_finalizacion = dtpHoraFinDescarga.Value;
                    _descarga_completa.Hora_diferencia = dtpHoraDiferenciaDescarga.Value;
                    _descarga_completa.Observaciones = txtObservacionesDescarga.Text;

                    _coordinacion.actualizarDescargaATM(_descarga_completa);
                }
                catch (Excepcion ex)
                {
                    ex.mostrarMensaje();
        ...
        /// Guardar los datos de una descarga full.
        /// </summary>
        private void guardarDescargaFullCompleta()
        {
            ...
            if (_descarga_full_mostrada)
            {
                ...
                try
                {
                    _descarga_full_completa.Fecha = dtpFechaDescargaFullCompleta.Value;
                    _descarga_full_completa.Hora_inicio = dtpHoraInicioDescargaFullCompleta.Value;
                    _descarga_full_completa.Hora_finalizacion = dtpHoraFinDescargaFullCompleta.Value;
                    _descarga_full_completa.Hora_diferencia = dtpHoraDiferenciaDescargaFullCompleta.Value;
                    _descarga_full_completa.Observaciones = txtObservacionesDescargaFullCompleta.Text;

                    //_coordinacion.actualizarDescargaATMFullCompleta(_descarga_full_completa);
                }
                catch (Excepcion ex)
                {
                    ex.mostrarMensaje();
        ...
        /// Agregar una descarga a la lista de descargas.
        /// </summary>
        public void agregarDescargaCompleta(DescargaATM descarga)
        {
            BindingList<DescargaATM> descargas = (BindingList<DescargaATM>)dgvDescargasCompletas.DataSource;


            descargas.Add(descarga);
            dgvDescargasCompletas.AutoResizeColumns();
        }
        ...
        /// Agregar una descarga full a la lista de descargas full.
        /// </summary>
        public void agregarDescargaFullCompleta(DescargaATMFull descarga)
        {
            BindingList<DescargaATMFull> descargas = (BindingList<DescargaATMFull>)dgvDescargasFullCompleta.DataSource;

            descargas.Add(descarga);
            dgvDescargasFullCompleta.AutoResizeColumns();
        }
