...
{
    public partial class frmCierreDescargas : Form
    {
        #region Atributos
        ...
        public frmCierreDescargas()
        {
            InitializeComponent();

        }

        public frmCierreDescargas(Colaborador usuario)
        {
            InitializeComponent();
        ...
        {
            _cierre_cargas = _coordinacion.obtenerCierreDescargaATM(dtpFecha.Value);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (cierre.ID == 0)
            {
                _coordinacion.agregarCierreDescargaATMs(ref cierre);
            }
            else
            {
                _coordinacion.actualizarCierreDescargaATMs(cierre);
            }
        }
        ...
        {
            _coordinacion.obtenerCierreDescargaATMDatos(dtpFecha.Value, ref _cierre_cargas);
