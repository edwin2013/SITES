...
{
    public partial class frmMantenimientoArqueos : Form
    {
        #region Atributos
        ...
        public frmMantenimientoArqueos(Colaborador usuario)
        {
            InitializeComponent();
            _usuario = usuario;
        }

        public frmMantenimientoArqueos(Colaborador usuario, Arqueo arqueo)
        {
            InitializeComponent();
            _usuario = usuario;
        ...
        {
            frmAdministracionArqueos _padre = (frmAdministracionArqueos)this.Owner; 
            ...
            try
            {
                ...
                //{
                    ...
                    Mensaje.mostrarMensaje("MensajeArqueoConfirmacionGeneracion");
